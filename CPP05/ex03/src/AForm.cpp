...
AForm::FormNameDoesNotExistException::FormNameDoesNotExistException(std::string _name) :
name(_name)
{}

AForm::FormNameDoesNotExistException::~FormNameDoesNotExistException() throw()
{

}

const char* AForm::FormNameDoesNotExistException::what() const throw()
{
	return "Form can't be created from this name.";
}

std::string AForm::FormNameDoesNotExistException::getValue() const
{
	return name;
}
